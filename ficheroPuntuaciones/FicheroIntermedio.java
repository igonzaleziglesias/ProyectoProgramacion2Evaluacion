...
public class FicheroIntermedio {
    ...
    public FicheroIntermedio() {
        fich = new File("/home/local/DANIELCASTELAO/igonzaleziglesias/Escritorio/puntuacionIntermedia.txt");
//        fich = new File("C:\\Users\\Usuario\\Desktop\\puntuaciones.txt");
    }

    public void añadirPuntuacion(int puntuacion) {
        try {
            f = new PrintWriter(new FileWriter("/home/local/DANIELCASTELAO/igonzaleziglesias/Escritorio/puntuacionIntermedia.txt", true));
